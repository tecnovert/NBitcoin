...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            .SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("pw"))
            .SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("pw"))
        ...
        protected override NetworkBuilder CreateTestnet()
        {
            ...
            .SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("tpw"))
            .SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("tpw"))
            .SetMagic(0x0b051108)
            .SetPort(51938)
            .SetRPCPort(51935)
            .SetMaxP2PVersion(90014)
        ...
        protected override NetworkBuilder CreateRegtest()
        {
            ...
            .SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("rtpw"))
            .SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("rtpw"))
            .SetMagic(0x0c061209)
            .SetPort(11938)
            .SetRPCPort(51936)
            .SetMaxP2PVersion(90014)
